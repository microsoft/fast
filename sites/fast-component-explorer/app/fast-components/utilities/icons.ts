...
export function placeholderIcon(
    ...
    const placeholderIconID = uniqueId("CollapsedIcon");
    const placeholderIconPath1 = uniqueId("CollapsedIconPath1");
    return [
        {
            [placeholderIconID]: {
                parent: {

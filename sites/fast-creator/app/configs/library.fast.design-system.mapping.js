...
export function setupFASTComponentDesignSystem(element) {
...
export function mapFASTComponentsDesignSystem(element, designSystem) {
    Object.entries(designSystem).forEach(([attribute, value]) => {
        switch (attribute) {
            case "fill-color":

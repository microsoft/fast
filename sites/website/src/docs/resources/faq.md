...
* CSS Behaviors - Custom elements enable FAST to dynamically add/remove styles based on runtime conditions, such as toggling high contrast mode. They also enables components to hook into the *design system* and respond to design changes over time.

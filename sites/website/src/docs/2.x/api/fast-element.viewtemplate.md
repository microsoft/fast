...
[Home](./index.md) &gt; [@microsoft/fast-element](./fast-element.md) &gt; [ViewTemplate](./fast-element.viewtemplate.md)
...
```
**Implements:** [ElementViewTemplate](./fast-element.elementviewtemplate.md)<!-- -->&lt;TSource, TParent&gt;, [SyntheticViewTemplate](./fast-element.syntheticviewtemplate.md)<!-- -->&lt;TSource, TParent&gt;
...
[(constructor)(html, factories, policy)](./fast-element.viewtemplate._constructor_.md)
...
[factories](./fast-element.viewtemplate.factories.md)
...
[html](./fast-element.viewtemplate.html.md)
...
[create(hostBindingTarget)](./fast-element.viewtemplate.create.md)
...
[create(strings, values, policy)](./fast-element.viewtemplate.create.md)
...
[inline()](./fast-element.viewtemplate.inline.md)
...
[render(source, host, hostBindingTarget)](./fast-element.viewtemplate.render.md)
...
[withPolicy(policy)](./fast-element.viewtemplate.withpolicy.md)

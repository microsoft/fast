...
title: fast-radio
sidebar_label: radio
custom_edit_url: https://github.com/microsoft/fast/edit/main/sites/website/versioned_docs/version-legacy/components/fast-radio.mdx
...
For a more ergonomic usage of radios in groups, see [the `fast-radio-group` documentation](./fast-radio-group.mdx).
...
* [Component technical specification](https://github.com/microsoft/fast/tree/archives/fast-foundation-3/packages/web-components/fast-foundation/src/radio/radio.spec.md)

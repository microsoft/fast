...
custom_edit_url: https://github.com/microsoft/fast/edit/main/packages/web-components/fast-foundation/src/search/README.md
---
...
* [Component technical specification](https://github.com/microsoft/fast/tree/archives/fast-foundation-3/packages/web-components/fast-foundation/src/search/search.spec.md)

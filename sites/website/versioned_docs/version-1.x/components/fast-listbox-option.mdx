...
custom_edit_url: https://github.com/microsoft/fast/edit/main/sites/website/versioned_docs/version-legacy/components/fast-listbox-option.mdx
...
The `<fast-option>` component will only provide internals related to form association when used within a form-associated component such as [`fast-select`](./fast-select.mdx) or [`fast-combobox`](./fast-combobox.mdx). It will not provide these capabilities when used only with a [`fast-listbox`](./fast-listbox.mdx).
...
See [`fast-select`](./fast-select.mdx), [`fast-combobox`](./fast-combobox.mdx), or [`fast-listbox`](./fast-listbox.mdx).
...
* [Component technical specification](https://github.com/microsoft/fast/tree/archives/fast-foundation-3/packages/web-components/fast-foundation/src/listbox-option/listbox-option.spec.md)

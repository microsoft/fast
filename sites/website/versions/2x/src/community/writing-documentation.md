...
layout: 2x
eleventyNavigation:
  key: writing-documentation2x
  parent: community2x
  title: Writing documentation
navigationOptions:
  activeKey: writing-documentation2x
...
custom_edit_url: https://github.com/microsoft/fast/edit/main/sites/website/versions/2x/src/community/writing-documentation.md
---
```

...
export const FastFrameTemplate = html`
    <template>
        <div class="wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="content-control-container">
                            ...
                            <fast-switch
                                ...
                                @change="${(x, c) => x.modeChange(c.event)}"
                            >
                    ...
                    <div class="content">
                        ...
                        <div class="content-control-container">
                            ...
                            <fast-radio-group
                                ...
                                @change="${(x, c) => x.neutralChangeHandler(c.event)}"
                            >
                                ${repeat(
                            ...
                            <fast-radio-group
                                ...
                                @change="${(x, c) => x.accentChangeHandler(c.event)}"
                            >
                                ${repeat(
                            ...
                            <fast-slider
                                ...
                                step="1"
                                value="${x => x.hue}"
                                @change="${(x, c) => x.hueChangeHandler(c.event)}"
                            >
                            ...
                            <fast-slider
                                ...
                                @change="${(x, c) => x.saturationChangeHandler(c.event)}"
                            >
                                <div
                                    slot="track"
                    ...
                    <div class="content">
                        ...
                        <div class="content-control-container-2">
                            ...
                            <fast-slider
                                ...
                                value="3"
                                @change="${(x, c) =>
                                    x.borderRadiusChangeHandler(c.event)}"
                            >
                            ...
                            <fast-slider
                                ...
                                step="1"
                                value="1"
                                @change="${(x, c) => x.strokeWidthChangeHandler(c.event)}"
                            >
                            ...
                            <fast-slider
                                ...
                                step="1"
                                value="0"
                                @change="${(x, c) => x.densityChangeHandler(c.event)}"
                            >
            ...
            >
                <div class="responsive-expand-flipper">
                    <fast-flipper
                        ...
                        aria-hidden="false"
                        @keypress="${(x, c) => x.handleExpandKeypress(c.event)}"
                        @click="${(x, c) => x.handleExpandKeypress(c.event)}"
                    ></fast-flipper>
                </div>
                <fast-card>

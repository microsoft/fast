...
let SiteBackgroundDesign = class SiteBackgroundDesign extends BackgroundDesign {};
SiteBackgroundDesign = __decorate(
    [
        customElement({
    ...
    SiteBackgroundDesign
);
export { SiteBackgroundDesign };

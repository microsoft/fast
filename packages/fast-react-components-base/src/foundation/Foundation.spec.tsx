...
describe("setRef", () => {
    ...
    class GetRefTestComponent extends Foundation<undefined, undefined> {
        render() { return <div ref={this.setRef("foobar")} />; }
    }
    ...
    test("should store the returned method under the path determined by args", () => {
        let stringCallback = getRefTestComponent.setRef("string");
        let numberCallback = getRefTestComponent.setRef(0);
        let stringAndNumberCallback = getRefTestComponent.setRef("stringAndNumber", 0);
    ...
    test("should not factor booleans into the referenceResolvers object structure", () => {
        let stringCallback = getRefTestComponent.setRef("string", true);
        let numberCallback = getRefTestComponent.setRef(0, true);
        let stringAndNumberCallback = getRefTestComponent.setRef("stringAndNumber", 0, true);
        let stringAndNumberCallback1 = getRefTestComponent.setRef("stringAndNumber[1]", true);

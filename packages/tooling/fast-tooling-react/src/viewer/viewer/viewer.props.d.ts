...
export declare enum ViewerCustomAction {
    call = "call",
    response = "response",
}
export declare type ViewerManagedClasses = ManagedClasses<ViewerClassNameContract>;
export declare type ViewerUnhandledProps = React.AllHTMLAttributes<HTMLElement>;
...
export declare type ViewerProps = ViewerUnhandledProps & ViewerHandledProps;

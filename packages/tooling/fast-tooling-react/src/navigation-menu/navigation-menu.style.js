...
const styles = {
    ...
    navigationMenuItem_listItem: Object.assign(
        Object.assign(
            Object.assign({}, applyTriggerStyle(inactiveTextColorCSSProperty)),
            {
                display: "block",
                width: "100%",
                textAlign: "start",
        ...
        applyFocusVisible(Object.assign({}, insetStrongBoxShadow(accentColorCSSProperty)))
    ),

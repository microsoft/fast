...
export declare type NavigationMenuItemUnhandledProps = React.HTMLAttributes<HTMLElement>;
...
export declare type NavigationMenuItemProps = NavigationMenuItemUnhandledProps &

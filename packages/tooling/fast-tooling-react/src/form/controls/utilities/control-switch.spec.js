...
const selectControl = new StandardControlPlugin({
    control: config => {
        return <SelectControl {...config} />;
    },
});
const arrayControl = new StandardControlPlugin({
    context: ControlContext.fill,
    control: config => {
        return <ArrayControl {...config} />;
    },
});
const linkedDataControl = new StandardControlPlugin({
    context: ControlContext.default,
    control: config => {
        return <LinkedDataControl {...config} />;
    },
});
const numberFieldControl = new StandardControlPlugin({
    control: config => {
        return <NumberFieldControl {...config} />;
    },
});
const checkboxControl = new SingleLineControlPlugin({
    control: config => {
        return <CheckboxControl {...config} />;
    },
});
const sectionLinkControl = new StandardControlPlugin({
    control: config => {
        return <SectionLinkControl {...config} />;
    },
});
const sectionControl = new StandardControlPlugin({
    control: config => {
        return <SectionControl {...config} />;
    },
});
const textareaControl = new StandardControlPlugin({
    control: config => {
        return <TextareaControl {...config} />;
    },
});
const displayControl = new StandardControlPlugin({
    control: config => {
        return <DisplayControl {...config} />;
    },
});
const buttonControl = new StandardControlPlugin({
    control: config => {
...
describe("ControlSwitch", () => {
    ...
    describe("should pass all config properties to the template", () => {
        describe("common properties", () => {
            ...
            test("schemaLocation", () => {
                const schemaLocation = "properties.text";
                const rendered = mount(
                    <TestControlSwitch
                        {...formControlSwitchProps}
                        schema={textareaSchema.properties.textWithDefault}
            ...
            test("schema", () => {
                const schema = textareaSchema.properties.textWithDefault;
                const rendered = mount(
                    <TestControlSwitch
                        {...formControlSwitchProps}
                        schema={schema}
            ...
            test("displayValidationBrowserDefault", () => {
                const displayValidationBrowserDefault = true;
                const rendered = mount(
                    <TestControlSwitch
                        {...formControlSwitchProps}
            ...
            test("displayValidationInline", () => {
                const displayValidationInline = true;
                const rendered = mount(
                    <TestControlSwitch
                        {...formControlSwitchProps}

...
export declare type PropsOnChange = (data: any) => void;
export declare type LocationOnChange = (dataLocation: string) => void;
export declare type BreadcrumbItemEventHandler = (
    e: React.MouseEvent<HTMLAnchorElement>
) => void;
export declare type FormTag = "form" | "div";

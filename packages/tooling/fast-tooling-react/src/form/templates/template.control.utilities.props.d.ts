...
export declare type UpdateNavigationCallback = (
    dictionaryId: string,
    navigationConfigId?: string
) => void;
export declare type FormHTMLElement =
    | HTMLTextAreaElement
    | HTMLInputElement
    | HTMLSelectElement
    | HTMLButtonElement;
...
export declare type NumberFieldTypeControlConfig = CommonControlConfig &
    NumberFieldTypeControlOptions;
export declare type LinkedDataControlConfig = CommonControlConfig &
    LinkedDataControlOptions;
export declare type ListControlConfig = CommonControlConfig & ListControlOptions;
export declare type TextareaControlConfig = CommonControlConfig & TextareaControlOptions;
export declare type SectionLinkControlConfig = CommonControlConfig &
    SectionLinkControlOptions;
export declare type SectionControlConfig = CommonControlConfig & SectionControlOptions;
export declare type ArrayControlConfig = CommonControlConfig & ArrayControlOptions;
export declare type ControlConfig = CommonControlConfig &
    NumberFieldTypeControlOptions &
    LinkedDataControlOptions &
    ListControlOptions &
    TextareaControlOptions &

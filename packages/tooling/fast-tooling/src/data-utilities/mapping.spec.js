...
describe("mapDataDictionary", () => {
    ...
    it("should map a single dictionary entry", () => {
        const mapper = function (config) {
            config.dataDictionary[0][config.dictionaryId].data =
                config.dataDictionary[0][config.dictionaryId].data;
        };
        const resolver = function (config) {
        ...
        const result = mapDataDictionary({
            dataDictionary: [
                {
                    "": {
                        schemaId: "foo",
...
describe("mapWebComponentDefinitionToJSONSchema", () => {
    ...
    it("should map attributes and slots to the JSON schema", () => {
        const name = "foo";
        const title = "FooBar";
        const description = "foo tag";
        const attrName = "attr";
        const attrTitle = "attr title";
        const attrDescription = "An attribute";
        const slotName = "";
        const slotTitle = "Default slot";
        const slotDescription = "The default slot";
        expect(
            mapWebComponentDefinitionToJSONSchema({
                version: 1,
                tags: [
    ...
    it("should map named slots to the JSON schema", () => {
        ...
        const slotName = "test";
        const slotTitle = "Default slot";
        const slotDescription = "Default slot description";
        expect(
            mapWebComponentDefinitionToJSONSchema({
                version: 1,
                tags: [

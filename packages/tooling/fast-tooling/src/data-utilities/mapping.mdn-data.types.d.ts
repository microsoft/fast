...
declare type order =
    ...
    | "perGrammar"
    | "uniqueOrder";
export declare type status = "standard" | "nonstandard" | "experimental" | "obsolete";
declare type mediaSingle =
    | "all"
    | "aural"
    | "continuous"
    | "interactive"
...
declare type mediaItem = "interactive" | "paged" | "visual";
declare type media = mediaSingle | mediaItem[];
declare type groupList =
    | "Basic Selectors"
    | "Combinators"
    ...
    | "Selectors"
    | "WebKit Extensions";
export declare type percentages =

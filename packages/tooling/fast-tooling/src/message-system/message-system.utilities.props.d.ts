 ...
 */
export declare enum MessageSystemDataDictionaryTypeAction {
    get = "get",
    updateActiveId = "update-active-id",
}
export declare enum MessageSystemDataTypeAction {
    update = "update",
    remove = "remove",
    add = "add",
    duplicate = "duplicate",
...
export declare enum MessageSystemNavigationDictionaryTypeAction {
    get = "get",
    updateActiveId = "update-active-id",
}
export declare enum MessageSystemNavigationTypeAction {
    update = "update",
    get = "get",
}
export declare enum MessageSystemValidationTypeAction {
    update = "update",
    get = "get",
}
export declare enum MessageSystemHistoryTypeAction {
    get = "get",
}
export declare enum MessageSystemSchemaDictionaryTypeAction {
    add = "add",
}
 ...
 */
export declare type DataMessageIncoming =
 ...
 */
export declare type DataMessageOutgoing =
 ...
 */
export declare type CustomMessage<T, OConfig> = CustomMessageIncomingOutgoing<OConfig> &
    T;
/**
 * Incoming navigation dictionary messages to the message system
 */
export declare type NavigationDictionaryMessageIncoming =
 ...
 */
export declare type NavigationDictionaryMessageOutgoing =
 ...
 */
export declare type DataDictionaryMessageIncoming =
 ...
 */
export declare type DataDictionaryMessageOutgoing =
 ...
 */
export declare type MessageSystemOutgoing<C = {}, OConfig = {}> =

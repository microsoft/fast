...
export class AjvMapper {
    constructor(config) {
        ...
        this.ajv = new Ajv({ schemaId: "auto", allErrors: true });
        /**
                ...
                case MessageSystemType.data:
                    if (
                        ...
                        if (e.data.action === MessageSystemDataTypeAction.addLinkedData) {
                            const linkedDataRootId = e.data.navigation[1];
        ...
        this.validateData = (data, schema) => {
            ...
            if (ajvValidationObject === true) {
                ...
                return this.ajv.errors.map(AjvError => {

...
export const AccentFillRestProperty = assignCSSCustomProperty(AccentFillRestName, AccentFillRestValue);

export const BackgroundColorName = `${propertyNamePrefix}background-color`;
const BackgroundColorValue = "#fff";
export const BackgroundColorProperty = assignCSSCustomProperty(BackgroundColorName, BackgroundColorValue);

export const ForegroundColorName = `${propertyNamePrefix}foreground-color`;
const ForegroundColorValue = "#2B2B2B";
export const ForegroundColorProperty = assignCSSCustomProperty(ForegroundColorName, ForegroundColorValue);

export const FocusOutlineWidthName = `${propertyNamePrefix}focus-outline-width`;
const FocusOutlineWidthValue = "2";
export const FocusOutlineWidthProperty = assignCSSCustomProperty(FocusOutlineWidthName, FocusOutlineWidthValue);
...
export const LineHeight1Property = assignCSSCustomProperty(LineHeight1Name, LineHeight1Value);
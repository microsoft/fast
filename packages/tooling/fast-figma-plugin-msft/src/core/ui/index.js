...
Swatch;
CornerRadius;
export class PluginUI extends React.Component {
    constructor() {
        super(...arguments);
        this.removeRecipe = type => {
    ...
    setDesignSystemProperty(property, value, nodeIds) {
        this.props.dispatch({
            type: MessageTypes.designSystem,
            action: MessageAction.assign,
            property,
    ...
    deleteDesignSystemProperty(property, nodeIds) {
        this.props.dispatch({
            type: MessageTypes.designSystem,
            action: MessageAction.delete,
            property,

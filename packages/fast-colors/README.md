...
A huge thanks to [https://github.com/bobbyrayit](https://github.com/bobbyrayit) and [https://github.com/mlijanto](https://github.com/mlijanto) for creating the algorithm implemented in the `range` function.

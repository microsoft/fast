 ...
 */
export type CSSRuleResolver = (config?: any) => string;
...
export interface ICSSRules {
    [rule: string]: CSSRuleResolver | string;
}
...
/**
 * The interface for props that the JSSManager injects into its child
 */
export interface IInjectedProps {
    managedClasses: IClassNames;
}
 ...
 * with styles managed
 */
function manageJss(styles?: IComponentStyles): <T>(Component: React.ComponentType<T & IInjectedProps>) => React.ComponentType<T> {
    return function<T>(Component: React.ComponentType<T & IInjectedProps>): React.ComponentType<T> {
        ...
        class JSSManager extends React.Component<T, IJSSManagerState> {
             ...
             */
            private static componentMap: WeakMap<React.ComponentType<T & IInjectedProps>, string> = new WeakMap();
             ...
             */
            private getClassNames(): IClassNames {

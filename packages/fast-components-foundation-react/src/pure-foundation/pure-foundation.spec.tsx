...
import { HandledProps, ReferenceResolver } from "../";
import * as ReactTestUtils from "react-dom/test-utils";
import { has, merge } from "lodash-es";

class GetRefTestComponent extends PureFoundation<{}, {}, {}> {
...
describe("unhandledProps", () => {
    ...
    class UnhandledPropsTestComponent extends PureFoundation<
...
describe("generateClassNames", () => {
    class ApplyClassNameComponent extends PureFoundation<any, any, any> {
        public render(): JSX.Element {

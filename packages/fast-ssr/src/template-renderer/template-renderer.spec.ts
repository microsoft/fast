...
import { deepStrictEqual, doesNotThrow, notStrictEqual, ok, strictEqual } from "node:assert/strict";
...
describe("TemplateRenderer", () => {
    describe("should have a createRenderInfo method", () => {
        test("that returns unique object instances for every invocation", () => {
            const renderer = new DefaultTemplateRenderer();
            notStrictEqual(renderer.createRenderInfo(), renderer.createRenderInfo())
        });
        test("that can be populated with ElementRenderers with the 'withDefaultElementRenderer()' method", () => {
            ...
            strictEqual(renderer.createRenderInfo().elementRenderers.includes(MyRenderer), true);
        });
    })

    describe("rendering <template> elements", () => {
        test("should render a template element without attributes", () => {
            ...
            strictEqual(consolidate(result), "<template></template>");
        });
        test("should render a template element with static attributes", () => {
            ...
            strictEqual(consolidate(result), `<template name="foo" id="bar"></template>`);
        });
        test("should render a template element with dynamic attributes", () => {
            ...
            strictEqual(consolidate(result), `<template name="bar" id="bat"></template>`);
        });
        test("should render a template element with a boolean attribute binding", () => {
            ...
            strictEqual(consolidate(result), `<template true ></template>`);
        });
        test("should render a template element with a classList property binding", () => {
            ...
            strictEqual(consolidate(result), `<template class="a b"></template>`);
        });
        ...
        test("should render a template element with both static and dynamic attributes", () => {
            ...
            strictEqual(consolidate(result), `<template id="bar" name="foo"></template>`);
        });
        ...
        test("should escape dynamic string attributes", () => {
            ...
            strictEqual(consolidate(result), `<span name="${escapeHtml(attrValue)}"></span>`);
        })
        test("should render a template with content", () => {
            ...
            strictEqual(consolidate(result), `<template name="bar"><p>Hello world</p></template>`);
        });
        test("should render a template as a child element", () => {
            const { templateRenderer } = fastSSR();
            const result = templateRenderer.render(html`<p><template name="bar"></template></p>`)

            strictEqual(consolidate(result), `<p><template name="bar"></template></p>`);
        });
    });

    describe("rendering declarative shadow DOM", () => {
        test("should emit static shadow DOM template for a defined custom element", () => {
            ...
            strictEqual(consolidate(result), `<with-slot><template shadowrootmode="open" shadowroot="open"><slot></slot></template></with-slot>`);
        });
        test("should emit template element with shadowroot and shadowrootmode attributes for defined custom element", () => {
            ...
            strictEqual(consolidate(result), `<hello-world><template shadowrootmode="open" shadowroot="open"></template></hello-world>`);
        });
        test("should render a custom element with a static attribute", () => {
            ...
            strictEqual(consolidate(result), `<hello-world  id="test"><template shadowrootmode="open" shadowroot="open"></template></hello-world>`);
        });
        ...
        test("should emit a custom element with attributes and properties reflected from an element's root <template> element", () => {
            ...
            strictEqual(consolidate(result), `<with-host-attributes  id="foo" static="static" dynamic="dynamic" bool-true><template shadowrootmode="open" shadowroot="open">value<slot></slot></template></with-host-attributes>`);
        });
    });
    describe("rendering a FAST element configured with a null shadowOptions config", () => {
        test("should not render declarative shadow DOM", () => {
            ...
            strictEqual(consolidate(result), `<${name}></${name}>`);
        });
        ...
        test("should render it's template inside element boundary markers to the light DOM", () => {
            ...
            deepStrictEqual(validationResult, true);
        });
        ...
        test("should render child elements into the element's light DOM", () => {
            ...
            strictEqual(consolidate(result), `<${name}><p>Hello world</p></${name}>`);
        });
    });
    ...
    test("should emit a single element template", () => {
        ...
        strictEqual(consolidate(result), "<p>Hello world</p>")
    });
    ...
    test("should emit un-registered custom elements without any shadow DOM", () => {
        ...
        strictEqual(consolidate(result), "<unregistered-element>Hello world</unregistered-element>");
    });
    ...
    test("should not render the template for elements that have been disabled via the ElementRenderer", () => {
        ...
        for (const key of [name, definition, MyElement]) {
            ...
            strictEqual(consolidate(templateRenderer.render(html`<${html.partial(name)}></${html.partial(name)}>`)), `<${name}><template shadowrootmode="open" shadowroot="open"><p>Hello world</p></template></${name}>`);
            ElementRenderer.disable(key);
            strictEqual(consolidate(templateRenderer.render(html`<${html.partial(name)}></${html.partial(name)}>`)), `<${name}></${name}>`);
        }
    });

    describe("with deferHydration enabled", () => {
        test("should emit elements that have been disabled with defer-hydration attribute", () => {
            ...
            strictEqual(consolidate(result), `<${name} defer-hydration><p>Hello world</p></${name}>`);
        });
        ...
        test("should emit undefined custom elements with the defer-hydration attribute", () => {
            ...
            strictEqual(result, `<${name} defer-hydration></${name}>`);
        });
        ...
        test("should emit elements that have been disabled with defer-hydration attribute based on deferHydration function return value", () => {
            ...
            strictEqual(result, `<${noDeferName}></${noDeferName}><${deferName} defer-hydration></${deferName}>`);
        });
    ...
    test("should provide the defaultExecutionContext object to a binding", () => {
        ...
        strictEqual(calledWith, ExecutionContext.default);
    });
    ...
    test("should emit a native element with an attribute when the attr binding returns a string", () => {
        ...
        strictEqual(result, `<p id="test"></p>`);
    });
    ...
    test("should emit a custom element with an attribute binding when the attr binding returns a string", () => {
        ...
        strictEqual(consolidate(result), `<hello-world  my-attr="foobar"><template shadowrootmode="open" shadowroot="open"></template></hello-world>`);
    });
    test("should emit an element with a boolean attribute when the attr binding returns true", () => {
        ...
        strictEqual(result, `<input type="checkbox" checked />`);
    });
    describe("should not emit an attribute", () => {
        test("for a boolean attribute binding that returns false", () => {
            ...
            strictEqual(result, `<input type="checkbox"  />`);
        });
    ...
    test("should evaluate bindings for html element", () => {
        ...
        strictEqual(result, `<html attr="value"></html>`);
    });
    test("should evaluate bindings for head element", () => {
        ...
        strictEqual(result, `<head attr="value"></head>`);
    });
    ...
    test("should evaluate bindings for body element", () => {
        ...
        strictEqual(result, `<body attr="value"></body>`);
    });
    ...
    test("should emit embedded templates", () =>{
        ...
        strictEqual(result, `<p>Hello <span>world</span></p>`);
    });

    describe("binding the the classList", () => {
        test("should emit class attribute to native elements", () => {
            ...
            strictEqual(result, `<p class="foo bar">Hello world</p>`);
        });
        test("should emit class attribute to custom elements", () => {
            ...
            strictEqual(result, `<hello-world  class="foo bar"><template shadowrootmode="open" shadowroot="open"></template></hello-world>`);
        });
    });
    describe("binding an event", () => {
    ...
    test("should render content bindings into style elements", () => {
        ...
        strictEqual(consolidate(templateRenderer.render(`<${name}></${name}>`)), `<${name}><template shadowrootmode="open" shadowroot="open"><style>div[id="foo"]{display: none;}</style></template></${name}>`)
    })

    /**
     * Directive tests
     */
    describe("with a 'when' directive", () => {
    ...
    describe("with a 'repeat' directive", () => {
        test("should provide parent and parentContext to execution context of bindings in child template", () => {
            ...
            consolidate(templateRenderer.render(html<typeof source>`${repeat(x => x.data, html<string>`${(x, c) => {
                strictEqual(c.parent, source);
                strictEqual(c.parentContext, ctx)
        ...
        test("should provide positioning information when invoked with the positioning config", () => {
            ...
            let i = 0;
            consolidate(templateRenderer.render(html<typeof source>`${repeat(x => x.data, html<string>`${(x, c) => {
                strictEqual(c.index, i);
                i++;
                strictEqual(c.length, c.parent.data.length)
        ...
        test("should render the provided template with the instance as the source data", () => {
            ...
            strictEqual(consolidate( result ), "foobarbat");
        });
    });

    describe("with a 'render' directive", () => {
        test("should provide parent and parentContext to execution context of bindings in child template", () => {
        ...
        test("should render the provided template with the binding's value as the source data", () => {
            ...
            strictEqual(consolidate( result ), "test");
        });
    });

    for (const directive of [children, ref, slotted ]) {
        describe(`with '${directive.name}' directive`, () => {
            test("should interpolate empty string", () => {
                ...
                strictEqual(consolidate(result), "<ul ><li>Hello</li><li>World</li></ul>")
            });
        });
    }
    ...
    describe("with hydration binding emission enabled", () => {
        test("should emit a comment with the binding index when the binding is interpolated into element content", () => {
            ...
            strictEqual(result, `<${name} needs-hydration><template shadowrootmode="open" shadowroot="open"><p>${hydrationMarker.contentBindingStart(0, codes.id)}hello world${hydrationMarker.contentBindingEnd(0, codes.id)}</p></template></${name}>`)
        });
        test("should emit a marker attribute to an element with a attribute binding ", () => {
            ...
            strictEqual(result, `<${name} needs-hydration><template shadowrootmode="open" shadowroot="open"><p attr="value" ${hydrationMarker.attribute([0])}></p></template></${name}>`)
        });
        test("should emit a marker attribute to an element with a boolean attribute binding ", () => {
            ...
            strictEqual(result, `<${name} needs-hydration><template shadowrootmode="open" shadowroot="open"><p attr ${hydrationMarker.attribute([0])}></p></template></${name}>`)
        });
        test("should emit a marker attribute to an element with a property binding", () => {
            ...
            strictEqual(result, `<${name} needs-hydration><template shadowrootmode="open" shadowroot="open"><p  ${hydrationMarker.attribute([0])}></p></template></${name}>`)
        });
        ...
        test("should emit a all binding ids to the marker attribute to an element with multiple attribute bindings", () => {
            ...
            strictEqual(result, `<${name} needs-hydration><template shadowrootmode="open" shadowroot="open"><p   ${hydrationMarker.attribute([0, 1])}></p></template></${name}>`)
        });
        ...
        test("should restart marker indexes after multiple host bindings of different types", () => {
            ...
            for (const order of permutations) {
                ...
                ok(result.includes(`disabled`));
                ok(result.includes(`attr="value"`));
                ok(result.includes(`needs-hydration`));
                ok(result.includes(`<span attr="value" ${hydrationMarker.attribute([0])}></span>`));
                ok(result.includes(`</${name}>`));
            }
        });
    ...
    describe("Disconnecting elements", () => {
    ...
    describe("with tryRecoverFromErrors", () => {
        ...
        test("should not emit host binding attributes after handling error", () => {
            ...
            strictEqual(result, `<${name}  contextual-attribute="value"></${name}>`);
        });

...
describe("getSwipeDirection", () => {
    ...
    test("should return right swipe direction", () => {
        expect(getSwipeDirection(PointerGesture.PanRight)).toBe(
            PointerGesture.SwipeRight
        );
    });

    test("should return up-left swipe direction", () => {
        expect(getSwipeDirection(PointerGesture.PanUpLeft)).toBe(
            PointerGesture.SwipeUpLeft
        );
    });

    test("should return up-right swipe direction", () => {
        expect(getSwipeDirection(PointerGesture.PanUpRight)).toBe(
            PointerGesture.SwipeUpRight
        );
    });

    test("should return down-left swipe direction", () => {
        expect(getSwipeDirection(PointerGesture.PanDownLeft)).toBe(
            PointerGesture.SwipeDownLeft
        );
    });

    test("should return down-right swipe direction", () => {
        expect(getSwipeDirection(PointerGesture.PanDownRight)).toBe(
            PointerGesture.SwipeDownRight
        );
    });
});

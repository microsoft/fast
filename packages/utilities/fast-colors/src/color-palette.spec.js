...
describe("Palette generation", () => {
    test("paletteGeneration", () => {
        function testColor(data) {
            const rgba = ColorRGBA64.fromObject(data.rgba);
    ...
    test("generateScaledPalettes", () => {
        const results1 = generateScaledPalettes(parseColorHexRGB("#d9b6f3"));
        ...
        const results2 = generateScaledPalettes(parseColorHexRGB("#006699"), 11, {
            targetSize: 63,
            spacing: 5,
    ...
    test("rescale", () => {
        const testPalette1 = generateOffCenterPalette(parseColorHexRGB("#320198"), 11);
        const results1 = rescale(testPalette1.palette, 63, false);
        ...
        const results2 = rescale(testPalette1.palette, 63, true);

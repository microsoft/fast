...
import { BasePalette, Palette } from "./palette.js";
...
/**
 * Options to tailor the generation of {@link PaletteRGB}.
 *
 * @public
 */
...
function from(source: any, options?: Partial<PaletteRGBOptions>): PaletteRGB {
    return source instanceof SwatchRGB
...
/**
 * A {@link Palette} with {@link SwatchRGB} values.
 */
class PaletteRGBImpl extends BasePalette<SwatchRGB> {
    /**

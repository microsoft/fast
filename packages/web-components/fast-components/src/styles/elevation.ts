...
const directionalShadow =
    "0 calc(var(--elevation) * 0.5px) calc((var(--elevation) * 1px)) rgba(0, 0, 0, 0.2)";
...
/** @public */
export const elevationShadowTooltipSize = DesignToken.create<number>(
    "elevation-shadow-tooltip-size"
).withDefault(16);
/** @public */
export const elevationShadowTooltip = DesignToken.create<string>(
    ...
    elevationShadowRecipe
        .getValueFor(element)
        .evaluate(element, elevationShadowTooltipSize.getValueFor(element))
);
...
/** @public */
export const elevationShadowDialogSize = DesignToken.create<number>(
    "elevation-shadow-dialog-size"
).withDefault(128);
/** @public */
export const elevationShadowDialog = DesignToken.create<string>(
    ...
    elevationShadowRecipe
        .getValueFor(element)
        .evaluate(element, elevationShadowDialogSize.getValueFor(element))
);

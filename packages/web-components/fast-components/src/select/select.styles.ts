...
export const selectStyles: FoundationElementTemplate<ElementStyles, SelectOptions> = (
    ...
    return css`
        ${display("inline-flex")} :host {
            --elevation: 14;
            --glyph-width: calc(${designUnit} * 4px);
        ...
        ${
            (selectContext &&
                css`
                    :host(:not([aria-expanded])) .listbox {
                        left: auto;
                        position: static;
                        z-index: auto;
                    }
        ...
        :host([aria-expanded]:not([open]):${focusVisible}) {
            box-shadow: 0 0 0 calc(${focusStrokeWidth} * 1px) ${focusStrokeOuter};
        }

        :host([aria-expanded]:${focusVisible}) ::slotted([aria-selected="true"][role="option"]:not([disabled])) {
        ...
        .selected-value {
            flex: 1 1 auto;
            font-family: inherit;
            min-width: calc(var(--option-width) - var(--glyph-width));
            overflow: hidden;
            text-align: start;
        ...
        ::slotted(svg) {
            ...
            fill: currentcolor;
            height: 1em;
            min-height: var(--glyph-width);
            min-width: var(--glyph-width);
            width: 1em;
        }

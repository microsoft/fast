...
The *CSS custom properties* exposed by the `FASTDesignSystemProvider` are:
- `background-color`
- `design-unit`
- `base-height-multiplier`
- `base-horizontal-spacing-multiplier`
- `corner-radius`
- `elevated-corner-radius`
- `outline-width`
- `focus-outline-width`
- `disabled-opacity`
...
The *properties* exposed on the FAST *design system* are the following:

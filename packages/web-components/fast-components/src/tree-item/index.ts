...
export const fastTreeItem = TreeItem.compose<TreeItemOptions>({
    ...
    expandCollapseGlyph: `
        ...
        >
            <path
                d="M4.5 8.94915C4.5 9.4861 5.13245 9.7731 5.53655 9.4195L8.6919 6.6586C9.0903 6.30995 9.0903 5.6902 8.6919 5.34155L5.53655 2.58066C5.13245 2.22706 4.5 2.51405 4.5 3.05102V8.94915Z"
            />
        </svg>
    `,
});

 ...
 * @internal
 */
export const accentForegroundCut_DEPRECATED: SwatchRecipe = accentForegroundCutFactory(
    4.5
);
 ...
 * @internal
 */
export const accentForegroundCutLarge_DEPRECATED: SwatchRecipe = accentForegroundCutFactory(
    3
);

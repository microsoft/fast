...
export function findSwatchIndex(
    ...
    return (designSystem: FASTDesignSystem): number => {
        ...
        const colorPalette: Palette = evaluateDesignSystemResolver(
            paletteResolver,
            designSystem
        );
        ...
        return (
            ...
            return (
                ...
                return (
                     ...
                     */
                    return (designSystem: FASTDesignSystem): Swatch => {
                        const color: Swatch = evaluateDesignSystemResolver(
                            referenceColor,
                            designSystem
                        );
                        const sourcePalette: Palette = evaluateDesignSystemResolver(
                            paletteResolver,
                            designSystem
                        );

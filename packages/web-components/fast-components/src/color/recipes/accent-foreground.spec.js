...
describe("accentForeground", () => {
    ...
    it("should increase contrast on hover state and decrease contrast on active state in either mode", () => {
    ...
    it("should have accessible rest and hover colors against the background color", () => {
        const accentColors = [
        ...
        accentColors.forEach(
            ...
            accent => {
                ...
                neutralPalette.swatches.forEach(swatch => {

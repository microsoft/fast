...
// dist/dts/custom-elements.d.ts:232:5 - (ae-incompatible-release-tags) The symbol "fastLoaderCard" is marked as @public, but its signature references "LoaderCard" which is marked as @internal

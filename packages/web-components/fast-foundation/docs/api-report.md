...
export const all: (
    key: any,
    searchAncestors?: boolean | undefined
...
// @public
export const darkModeStylesheetBehavior: (
...
export const DI: Readonly<{
        ...
        config?:
            | Partial<
                  Pick<
                      ...
                      "responsibleForOwnerRequests" | "defaultResolver"
                  >
              >
            | undefined
    ): Container;
    ...
    createInterface<K extends Key>(
        nameConfigOrCallback?:
            ...
            | undefined,
        configuror?: ((builder: ResolverBuilder<K>) => Resolver<K>) | undefined
    ): InterfaceSymbol<K>;
    inject(
        ...dependencies: Key[]
    ): (
...
// @public
export const forcedColorsStylesheetBehavior: (
    styles: ElementStyles
) => MatchMediaStyleSheetBehavior;

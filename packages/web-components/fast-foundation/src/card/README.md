...
| -------------- | ----------------------------------------------------------------------- | --------------------- | ------ |
| `cardTemplate` | The template for the {@link @microsoft/fast-foundation#Card} component. | `context, definition` |        |
...
| ---- | -------------- | ------------ | ------------------------- | ------- |
| `js` | `cardTemplate` | cardTemplate | src/card/card.template.ts |         |

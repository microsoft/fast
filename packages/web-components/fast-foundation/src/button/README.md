...
| `formaction`            | public  | `string`                                     |         | See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button or `<button>` element for more details.                                                         |                      |
| `formenctype`           | public  | `string`                                     |         | See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button or `<button>` element for more details.                                                         |                      |
| `formmethod`            | public  | `string`                                     |         | See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button or `<button>` element for more details.                                                         |                      |
| `formnovalidate`        | public  | `boolean`                                    |         | See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button or `<button>` element for more details.                                                         |                      |
| `formtarget`            | public  | `"_self" or "_blank" or "_parent" or "_top"` |         | See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button or `<button>` element for more details.                                                         |                      |

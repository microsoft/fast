...
export class DataGrid extends FASTElement {
    ...
    public generateHeader: AutoGeneratedHeaderOptions =
        AutoGeneratedHeaderOptions.default;
    ...
    private toggleGeneratedHeader(): void {
        ...
        if (this.generateHeader !== AutoGeneratedHeaderOptions.none) {
            ...
            this.generatedHeader.rowType =
                this.generateHeader === AutoGeneratedHeaderOptions.sticky

...
| `regionElement`             | public  | `HTMLElement or null`                      | `null`           | The HTML element being positioned                                                                                                                                                                                                       |                |
...
| `positionChangedCallback`   | public  | `() => void or undefined`                  |                  | invoked when position changes                                                                                                                                                                                                           |                |
| `loadedCallback`            | public  | `() => void or undefined`                  |                  | invoked when position changes                                                                                                                                                                                                           |                |
...
| `regionElementChanged`             | protected |                                 |                                                     | `void` |                |
| `initialize`                       | public    | fully initializes the component |                                                     | `void` |                |

...
| `name`          | public  | `string`                              |         | The name of the radio. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#htmlattrdefname or name attribute for more info.                                              |                     |

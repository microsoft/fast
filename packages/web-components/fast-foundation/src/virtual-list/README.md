...
| `loadContent`       | public  | `boolean`                             | `false` | Flag indicating whether the item should load contents                                                                                                                               |                   |
...
| `itemTemplate`          | public  | `ViewTemplate`                        |            | The ViewTemplate used to render items.                                                                                                                                                   |                   |

...
| `enterKeyHint` | public  | `or "enter"         or "done"         or "go"         or "next"         or "previous"         or "search"         or "send"` |         | defines what action label (or icon) to present for the enter key on virtual keyboards.                                                                                                                                      |                         |
...
| `enterKeyHintChanged` | protected |                                                   |            | `void` |                |

...
function setup() {
    return __awaiter(this, void 0, void 0, function* () {
        const { element, connect, disconnect } = yield fixture(FASTProgress());
...
describe("Progress ring", () => {
    ...
    it("should render an element with an `indeterminate` slot when no value is provided", () =>
        __awaiter(void 0, void 0, void 0, function* () {
            var _c, _d;
            const { element, connect, disconnect } = yield setup();
            yield connect();
            expect(
                (_d =
                    (_c = element.shadowRoot) === null || _c === void 0
                        ? void 0
                        : _c.querySelector(".progress")) === null || _d === void 0
                    ? void 0
                    : _d.getAttribute("slot")

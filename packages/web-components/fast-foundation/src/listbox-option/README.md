...
The `<fast-option>` component will only provide internals related to form association when used within a form-associated component. See the [`fast-select` component](/docs/components/select) for more details.

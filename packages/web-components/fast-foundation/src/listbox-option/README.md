...
| Name           | Privacy | Type                             | Default | Description                                                                    | Inherited From |
| -------------- | ------- | -------------------------------- | ------- | ------------------------------------------------------------------------------ | -------------- |
| `ariaChecked`  | public  | `"true" or "false" or undefined` |         | See {@link https://www\.w3.org/TR/wai-aria-1.2/#option} for more information. |                |
| `ariaPosInSet` | public  | `string`                         |         | See {@link https://www\.w3.org/TR/wai-aria-1.2/#option} for more information. |                |
| `ariaSelected` | public  | `"true" or "false" or undefined` |         | See {@link https://www\.w3.org/TR/wai-aria-1.2/#option} for more information. |                |

...
const expandedSVG = html<AccordionItem>`
...
const collapsedSVG = html<AccordionItem>`
    <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
...
export function createAccordionItemTemplate(
    expandedIcon?: ViewTemplate,
    collapsedIcon?: ViewTemplate
): ViewTemplate {
            ...
            >
                ...
                <span class="icon" part="icon" aria-hidden="true">
                    <slot name="expanded-icon" part="expanded-icon">
                        ${x => (expandedIcon !== undefined ? expandedIcon : expandedSVG)}
                    </slot>
                    <slot name="collapsed-icon" part="collapsed-icon">
                        ${x =>
                            collapsedIcon !== undefined ? collapsedIcon : collapsedSVG}
                    </slot>
                <span>
            </div>
            <div

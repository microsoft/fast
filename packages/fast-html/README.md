...
If observer-map data is updated from within existing observation callbacks, provide
an `updateScheduler` to defer observer-map array updates and avoid synchronous
reentrant array work:

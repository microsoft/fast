 ...
 *
 * To display the literal text of a FAST directive tag (e.g.
 * `<f-when value="{{flag}}">`) the author should write the tag's `<`
 * and `>` characters as `&lt;` and `&gt;` themselves — the FAST
 * preprocessor only neutralises braces, not directive tag delimiters.
 */

...
export type ListboxItemManagedClasses = ManagedClasses<ListboxItemClassNameContract>;
export type ListboxItemUnhandledProps = React.HTMLAttributes<HTMLDivElement>;

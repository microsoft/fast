 ...
 */
class DisplayFormControl extends BaseFormControl<
    DisplayFormControlProps & ManagedClasses<DisplayFormControlClassNameContract>,
    {}
> {
    public static displayName: string = "DisplayFormControl";
        ...
        return (
            <div className={this.generateClassNames()}>
                <div
                    className={get(
                        this.props,
                        "managedClasses.displayFormControl_controlRegion"
                    )}
                >
                    <div
                        className={get(
                            this.props,
                            "managedClasses.displayFormControl_control"
                        )}
                    >
                        <div
                            className={get(
                                this.props,
                                "managedClasses.displayFormControl_controlLabelRegion"
                            )}
                        >
                            <label
                                className={get(
                                    this.props,
                                    "managedClasses.displayFormControl_controlLabel"
                                )}
                            ...
                            {this.renderDefaultValueIndicator(
                                get(
                                    this.props,
                                    "managedClasses.displayFormControl_defaultValueIndicator"
                                )
                            )}
                            {this.renderBadge(
                                get(this.props, "managedClasses.displayFormControl_badge")
                            )}
                        </div>
                        <input
                            className={get(
                                this.props,
                                "managedClasses.displayFormControl_controlInput"
                            )}
                            type={"text"}
                            ref={this.inputRef}
                    ...
                    <div
                        className={get(
                            this.props,
                            "managedClasses.displayFormControl_softRemove"
                        )}
                    >
                        {this.renderSoftRemove(
                            get(
                                this.props,
                                "managedClasses.displayFormControl_softRemoveInput"
                            )
                        )}
                    </div>
                </div>
                {this.renderInvalidMessage(
                    get(this.props, "managedClasses.displayFormControl_invalidMessage")
                )}
            </div>
        );
    }
        ...
        if (this.props.data !== this.getValue()) {
            return (
                <button
                    className={get(
                        this.props,
                        "managedClasses.displayFormControl_constValueIndicator"
                    )}
    ...
    private generateClassNames(): string {
        let classes: string = get(this.props, "managedClasses.displayFormControl");

        if (this.props.disabled) {
            classes += ` ${get(
                this.props,
                "managedClasses.displayFormControl__disabled"
            )}`;
        }
...
export { DisplayFormControl };
export default manageJss(styles)(DisplayFormControl);

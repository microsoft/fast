 ...
 */
abstract class BaseFormControl<P, S> extends React.Component<
    P & CommonFormControlProps,
    S
> {
    public static defaultProps: Partial<CommonFormControlProps> = {
        softRemove: true,
    };
    ...
    constructor(props: P & CommonFormControlProps) {
        super(props);
    ...
    public componentDidUpdate(prevProps: P & CommonFormControlProps): void {
    ...
    public renderDefaultValueIndicator(className: string): React.ReactNode {
        if (
            ...
            return (
                <button
                    className={className}
                    onClick={this.handleUpdateValueToDefaultValue}
                >
                    <svg
                        viewBox="0 0 16 16"
                        height="14"
                    ...
                    >
                        <title>
                            This is the default value, click to set it as the value
                        </title>
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
    ...
    public updateValidity = (): void => {
        const formControlElement: HTMLElement = get(this, "formControlRef.current");

        if (formControlElement !== null && typeof formControlElement !== "undefined") {
            this.formControlRef.current.setCustomValidity(this.props.invalidMessage);
        }
    };
    ...
    public reportValidity = (): void => {
        ...
        if (this.props.displayValidationBrowserDefault) {
            this.formControlRef.current.reportValidity();
        }
    };
     ...
     */
    private handleUpdateValueToDefaultValue = (): void => {

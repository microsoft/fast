...
import { NumberFieldFormControl } from "./control.number-field";
...
const managedClasses: NumberFieldClassNameContractFormControl = {
    numberFieldFormControl: "numberFieldFormControl-class",
    numberFieldFormControl__disabled: "numberFieldFormControl__disabled-class",
    numberFieldFormControl_badge: "numberFieldFormControl_badge-class",
    numberFieldFormControl_control: "numberFieldFormControl_control-class",
    numberFieldFormControl_controlInput: "numberFieldFormControl_controlInput-class",
    numberFieldFormControl_controlLabel: "numberFieldFormControl_controlLabel-class",
    numberFieldFormControl_controlLabelRegion:
        "numberFieldFormControl_controlLabelRegion-class",
    numberFieldFormControl_controlRegion: "numberFieldFormControl_controlRegion-class",
    numberFieldFormControl_defaultValueIndicator:
        "numberFieldFormControl_defaultValueIndicator-class",
    numberFieldFormControl_invalidMessage: "numberFieldFormControl_invalidMessage-class",
    numberFieldFormControl_softRemove: "numberFieldFormControl_softRemove-class",
    numberFieldFormControl_softRemoveInput:
        "numberFieldFormControl_softRemoveInput-class",
};

const numberFieldProps: CommonFormControlProps = {
    index: 1,
    dataLocation: "",
    data: "",
    required: false,
...
describe("NumberFieldFormControl", () => {
    ...
    test("should fire the onChange callback to update the data to the default value if the default value indicator is clicked", () => {
        ...
        rendered
            .find(`.${managedClasses.numberFieldFormControl_defaultValueIndicator}`)
            .simulate("click");

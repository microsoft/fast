...
import { SectionLinkFormControl } from "./control.section-link";
import {
...
const managedClasses: SectionLinkFormControlClassNameContract = {
    sectionLinkFormControl: "sectionLinkFormControl-class",
    sectionLinkFormControl_anchor: "sectionLinkFormControl_anchor-class",
    sectionLinkFormControl_anchor__invalid:
        "sectionLinkFormControl_anchor__invalid-class",
    sectionLinkFormControl_badge: "sectionLinkFormControl_badge-class",
    sectionLinkFormControl_controlRegion: "sectionLinkFormControl_controlRegion-class",
    sectionLinkFormControl_defaultValueIndicator:
        "sectionLinkFormControl_defaultValueIndicator-class",
    sectionLinkFormControl_invalidMessage: "sectionLinkFormControl_invalidMessage-class",
    sectionLinkFormControl_softRemove: "sectionLinkFormControl_softRemove-class",
    sectionLinkFormControl_softRemoveInput:
        "sectionLinkFormControl_softRemoveInput-class",
};

const sectionLinkFormControlProps: SectionLinkFormControlProps = {
    index: 1,
    dataLocation: "",
    schemaLocation: "",
    data: "",
...
describe("SectionLinkFormControl", () => {
    ...
    test("should add an invalid data class if there is an invalid message", () => {
        ...
        expect(
            rendered.find(`.${managedClasses.sectionLinkFormControl_anchor__invalid}`)
        ).toHaveLength(1);
    });
    ...
    test("should fire the onChange callback to update the data to the default value if the default value indicator is clicked", () => {
        ...
        rendered
            .find(`.${managedClasses.sectionLinkFormControl_defaultValueIndicator}`)
            .simulate("click");

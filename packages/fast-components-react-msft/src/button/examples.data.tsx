...
export default {
    ...
    data: [
        ...
        {
            beforeContent: testGlyph,
            children: "Before render props",
        },
        {
            children: "After render props",
            afterContent: testGlyph,
        },
        {
        ...
        {
            children: "Primary after render props",
            afterContent: testGlyph,
            appearance: ButtonAppearance.primary,
        },
        {
            children: "Disabled primary after render props",
            afterContent: testGlyph,
            appearance: ButtonAppearance.primary,
            disabled: true,
        },
        {
            children: "Lightweight after render props",
            afterContent: testGlyph,
            appearance: ButtonAppearance.lightweight,
        },
        {
            children: "Disabled lightweight after render props",
            afterContent: testGlyph,
            appearance: ButtonAppearance.lightweight,
            disabled: true,
        },
        {
            children: "Outline after render props",
            afterContent: testGlyph,
            appearance: ButtonAppearance.outline,
        },
        {

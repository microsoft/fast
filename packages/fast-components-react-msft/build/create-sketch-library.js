 ...
 *
 * To use this script:
 * 1. Ensure you have the development site running - from the root of this project, run `yarn start` and wait until the website is built
 ...
 */
const extractSymbolLibrary = require("@microsoft/fast-sketch-library")

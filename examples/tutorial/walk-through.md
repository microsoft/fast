...
The web page itself is simple and has a menu, hero, gallery, contact, and footer sections.
...
This guide is assuming you are using Visual Studio Code and have already installed the Live Server extension. On your computer open a terminal and navigate to where you'd like to download the walkthrough files. Download the zipped source code from [here](<!--TODO: add link to demo code -->), or view the source in our [GitHub repository](<!--TODO: add link to GitHub location -->).

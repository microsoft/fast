...
4. **Build child state** from the attributes:
   - Attributes starting with `@` (event handlers) are **skipped** — they are resolved entirely by the FAST client runtime and have no meaning in server-side rendering state.

...
pub fn render(template: &str, root: &JsonValue) -> Result<String, RenderError> {
    render_node(template, root, &[], None, None, false, &RenderConfig::default())
}

pub fn render_with_locator(template: &str, root: &JsonValue, locator: &Locator) -> Result<String, RenderError> {
    render_node(template, root, &[], Some(locator), None, false, &RenderConfig::default())
}
...
pub fn render_entry_with_locator(template: &str, root: &JsonValue, locator: &Locator) -> Result<String, RenderError> {
    render_node(template, root, &[], Some(locator), None, true, &RenderConfig::default())
}

pub fn render_with_locator_and_config(template: &str, root: &JsonValue, locator: &Locator, config: &RenderConfig) -> Result<String, RenderError> {
    render_node(template, root, &[], Some(locator), None, false, config)
}

pub fn render_entry_with_locator_and_config(template: &str, root: &JsonValue, locator: &Locator, config: &RenderConfig) -> Result<String, RenderError> {
